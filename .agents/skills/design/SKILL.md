...
- `references/labels.md` — copy and labeling conventions: what a component says when
  data is missing vs. stale vs. unreachable, the AGENTS.md wording rules for signals,
...
1. **An existing screen violates a documented convention or a `AGENTS.md` rule** (a raw
