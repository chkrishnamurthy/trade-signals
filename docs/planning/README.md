...
| [multi-exchange-nse-bse-plan.md](multi-exchange-nse-bse-plan.md) | Make BSE a first-class exchange beside NSE for every data type — company/listing model, listing-keyed quotes, bhavcopy EOD, SENSEX, disclosures parity, 9 phases — 2026-09-25. **Proposed** |
